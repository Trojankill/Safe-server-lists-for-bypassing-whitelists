...
SOURCES = {
    ...
    # ИСПРАВЛЕНО: используем vless_lite.txt (проверенные подсети)
    "FILTER-3.txt": "https://raw.githubusercontent.com/zieng2/wl/main/vless_lite.txt",
...
def main():
    print("=== Фильтрация прокси (FILTER-3 теперь vless_lite.txt) ===")
